...
<style lang="scss">
@import '../style/Toast/transition.scss';
@import '../style/Toast/mask.scss';
@import '../style/Toast/weui_icon_font.scss';
@import '../style/Toast/weui_toast.scss';
